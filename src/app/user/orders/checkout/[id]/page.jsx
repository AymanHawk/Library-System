...
function Checkout() {
  ...
  return (
    <div className="flex flex-row flex-wrap justify-between m-6">
      <div className="border-secondary rounded-[5px] border-2 p-2 w-[48%] min-w-[300px] h-[600px] mb-6">
          ...
          <div key={libId}>
            ...
            <ul>
              {groupedBooks[libId].map((book) => (
                <li
                  div
                  className="flex flex-row justify-between items-start mt-4"
      ...
      <div className="flex flex-col w-[48%] min-w-[300px] mb-6">
        ...
        <button className="bg-primary text-background rounded-md h-[6%]" onClick={confirmOrder}>
          Confirm
        </button>
      </div>
    </div>
