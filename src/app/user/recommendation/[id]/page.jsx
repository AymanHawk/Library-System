    ...
    <div>
      ...
      <div className="mx-auto 2xl:w-[1400px] xl:w-[1250px] lg:w-[1000px] norm:w-[750px] md:w-[600px] sm:w-[450px] w-[350px] xs:w-[250px]">
        <div className="flex justify-between items-center">
          <h1 className="mb-[10px] text-primary text-[43px]">Recommendations</h1>
          <h1 onClick={() => { handleRoute(`/user/recommendation/survey/${id}`) }} className="mb-[10px] cursor-pointer transition-transform duration-300 hover:scale-[1.01] text-primary text-[25px]">Get New Recomendation</h1>
        </div>
        {!list ? (
          <div>
            <Loading />
