    ...
    <div className='2xl:w-[1300px] xl:w-[1200px] lg:w-[1000px] norm:w-[750px] md:w-[600px] sm:w-[450px] w-[340px] xs:w-[275px] mx-auto' >
      ...
      {results.length > 0 ? (
        <div className='flex flex-wrap lg:justify-between justify-center'>
          {results.map((book) => (
            <div key={book._id} className=' transition-transform duration-300 hover:scale-[1.01] flex 2xl:w-[650px] xl:w-[600px] lg:w-[500px] norm:w-[725px] md:w-[600px] sm:w-[450px] w-[340px] xs:w-[275px] 2xl:h-[300px] xl:h-[275px] lg:h-[225px] norm:h-[325px] md:h-[275px] sm:h-[200px]  h-[175px] xs:h-[150px] my-3'>
