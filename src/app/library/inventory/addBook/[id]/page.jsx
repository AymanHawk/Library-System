  ...
  return (
    ...
    <div>
      ...
      <div className='relative'>
        <div className= {(popUp ? '' : 'hidden ') + ` absolute bg-background border-secondary border-[1px] p-10 ml-40`}>
          <div>
            <Image src={cross} height={25} width={25} alt='cross' onClick={()=>{setPopUp(false)}}/>
          </div>
        ...
        <div className='flex gap-2 flex-wrap text-background'>
          <input type="text" className='w-full' value={title} placeholder='Title' onChange={(e) => setTitle(e.target.value)} />
          <input type="text" className='w-full' value={author} placeholder='Author(s)' onChange={(e) => setAuthor(e.target.value)} />
          <input type="text" className='w-full' value={publisher} placeholder='Publisher' onChange={(e) => setPublisher(e.target.value)} />
          <input type="date" className='w-full' value={date} placeholder='Publish Date' onChange={(e) => setDate(e.target.value)} />
          <input type="text" className='w-full' value={isbn} placeholder='ISBN' onChange={(e) => setIsbn(e.target.value)} />
          <input type="text" className='w-full' value={lang} placeholder='Language' onChange={(e) => setLang(e.target.value)} />
          <input type="text" className='w-full' value={length} placeholder='Length' onChange={(e) => setLength(e.target.value)} />
          <input type="text" className='w-full' value={format} placeholder='Format' onChange={(e) => setFormat(e.target.value)} />
          <input type="text" className='w-full' value={genre} placeholder='Genre' onChange={(e) => setGenre(e.target.value)} />
          <input type="file" className='w-full' value={imgSrc} placeholder='Image' onChange={(e) => setImg(e.target.value)} />
        </div>
