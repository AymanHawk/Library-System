...
function Loading() {
    return (
        <div className="flex flex-row flex-wrap mr-8 ml-8 mt-6 gap-1 justify-start sm:justify-center md:justify-evenly lg:justify-start">
            {[...Array(6)].map((_, index) => (
                <div key={index} className="flex flex-row w-[80%] sm:w-[400px] md:w-[360px] lg:w-[420px] sm:h-[400px] h-[250px] p-1 animate-pulse">
                    <div className="w-full lg:h-[350px] sm:h-[320px] h-[200px] bg-loading mr-4"></div>
