...
export default function NonFiction() {
  ...
  const getBooks = async () => {
    try {
      const response = await fetch("/api/browse/nonFiction", {
        method: "GET",
      });
      if (!response.ok) {
  ...
  return (
    <div>
      ...
      <div>
        <h1 className="ml-[10%] mt-[4%] mb-[2%] sm:mt-[2%] text-white text-2xl sm:text-3xl md:text-4xl lg:text-4xl xl:text-4xl">Most Rented Non-Fiction Books</h1>
        <div className="flex justify-between overflow-x-auto no-scrollbar mr-[10%] ml-[9%] w-[80%] sm:mr-auto sm:ml-auto">
